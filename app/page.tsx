...
const basePath = '/cnno-1775792098106';
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft exceptional sweet rolls that delight the senses, foster a sense of community, and provide unparalleled customer experiences, while continuously innovating and improving our products and services to meet the evolving needs of our customers.</p>
                </div>
                <div className="space-y-2">
